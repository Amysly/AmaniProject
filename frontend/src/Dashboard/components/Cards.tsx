...
const Cards: React.FC = () => {
  return (
    <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 mt-5">
      ...
      {/* Sales Card */}
      <div className="p-5 bg-gray-800 text-white rounded-lg shadow flex items-center">
        <div className="mr-4 border border-white p-3 rounded-full">
          <FaDollarSign size={30} />
        </div>
        <div>
          <h3 className="text-lg font-semibold">E-Payment</h3>
          <p>Payment Status: <span className="font-bold">$5000</span></p>
        </div>
      </div>
      ...
      <div className="p-5 bg-red-500 text-white rounded-lg shadow flex items-center">
        ...
        <div>
          ...
          <p>There have been <span className="font-bold">2</span> Courses registered.</p>
        </div>
      </div>
    </div>
  );
